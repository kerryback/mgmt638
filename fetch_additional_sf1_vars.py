...
print("Variables: dps (dividends), payoutratio, assetturnover")
...
# Fetch SF1 data with the needed variables
# We need: dps, payoutratio, assetturnover, assets, equity (to calculate equity_multiplier)
all_data = []
