...
|-------|-------------|--------------|
| [Rice Data Query](#rice-data-query) | Query the Rice Business Stock Market Data Portal using SQL | 11-04-2025 |
| [Merge](#merge) | Merge financial datasets with proper date alignment | 11-04-2025 |
