...
## What the Splits Say {.no-title}

![](images/session04-oos.svg){.nostretch width="100%"}

::: {.note .note-plum}
A negative out-of-sample R-squared is worse than predicting the mean. Log the
multiple and winsorize the features, and the ten splits stop disagreeing.
:::
