...
\begin{frame}{Agenda}
    \begin{enumerate}
    \item Machine learning and asset pricing paper 
    \item More random forests
    \item Creating Quality Minus Junk characteristics 
    \end{enumerate}
\end{frame}

\begin{frame}{Machine Learning and Asset Pricing}
\begin{itemize}
\item \href{https://mgmt638.kerryback.com/pdfs/Gu_Kelly_Xiu_RFS_2020.pdf}{PDF: \textit{Asset Pricing Via Machine Learning}, Gu, Kelly, and Xiu, 2020}
\item \href{https://mgmt638.kerryback.com/videos/Crane_Crotty_Umar_MS_2023.mp4}{Video: \textit{Asset Pricing Via Machine Learning}, Gu, Kelly, and Xiu, 2020}
\item \href{https://notebooklm.google.com/notebook/93761776-77e8-45ae-a5fa-3010fdf23d65}{NotebookLM: Asset Pricing Via Machine Learning}
\end{itemize}
\end{frame}
