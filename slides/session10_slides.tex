...
\href{https://mgmt638.kerryback.com/analyze-portfolios.ipynb}{analyze\_portfolios.ipynb}
...
\begin{enumerate}
\item Replace your .claude folder with the .claude folder in  \texttt{\href{https://mgmt638.kerryback.com/.claude.zip}{this zip file}}
...
\begin{frame}{Train-Predict Script}
\begin{itemize}
